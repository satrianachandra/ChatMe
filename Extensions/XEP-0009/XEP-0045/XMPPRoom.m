...
-(void)encodeWithCoder:(NSCoder *)aCoder{
    [aCoder encodeObject:xmppRoomStorage forKey:@"xmppRoomStorage"];
    [aCoder encodeObject:roomJID forKey:@"roomJID"];
    [aCoder encodeObject:myRoomJID forKey:@"myRoomJID"];
    [aCoder encodeObject:myNickname forKey:@"myNickname"];
    [aCoder encodeObject:roomSubject forKey:@"roomSubject"];
